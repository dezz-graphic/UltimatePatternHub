...
DefaultDirName={commoncf32}\Adobe\CEP\extensions\UltimatePatternHub
...
Source: "dist\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
